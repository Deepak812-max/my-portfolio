  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/Deepak812-max',
      label: 'GitHub',
      color: 'hover:text-gray-900',
    },
    {
      icon: <Linkedin className="h-6 w-6" />,
      url: 'https://www.linkedin.com/in/deepak-kumar-836a93253',
      label: 'LinkedIn',
      color: 'hover:text-blue-600',
    },
    {
      icon: <SiLeetcode className="h-6 w-6" />,
      url: 'https://leetcode.com/u/PnzDbwz2ia/',
      label: 'LeetCode',
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"> Deepak Kumar</span>
              </h1>
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href="./images/Front_end_developer1.pdf"
